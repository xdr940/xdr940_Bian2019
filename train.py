...
parser.add_argument('--data', metavar='DIR', help='path to dataset',
                    default="/home/roit/datasets/kitti_processed_data128512")
...
parser.add_argument('--pretrained-disp', dest='pretrained_disp',
                    ...
                    default='/home/roit/models/cc/official/dispnet_model_best.pth.tar')
parser.add_argument('--pretrained-pose', dest='pretrained_pose',
                    metavar='PATH', help='path to pre-trained Pose net model',
                    default='/home/roit/models/cc/official/posenet_model_best.pth.tar')
...
def main():
    ...
    args.save_path = Path('./checkpoints')/timestamp
